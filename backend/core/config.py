...
class Settings:
    ...
    market_data_adapter: str = os.getenv("MARKET_DATA_ADAPTER", "hybrid").strip().lower() or "hybrid"
    market_data_provider: str = os.getenv("MARKET_DATA_PROVIDER", "alpaca").strip().lower()
    ...
    execution_adapter: str = os.getenv("EXECUTION_ADAPTER", "desk").strip().lower() or "desk"
