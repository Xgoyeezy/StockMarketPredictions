...
class InstitutionalQuantReadinessServiceTests(unittest.TestCase):
    ...
    def test_final_institutional_runbook_tests_lineage_audit_and_external_review_contracts(self) -> None:
        ...
        self.assertIn("approval_trace_evidence_reference", external_review["evidence_packet_fields"])
        self.assertIn("audit_event_evidence_reference", external_review["evidence_packet_fields"])
        self.assertIn("model_version_evidence_reference", external_review["evidence_packet_fields"])
        self.assertIn("execution_lineage_evidence_reference", external_review["evidence_packet_fields"])
        self.assertIn("release_validation_evidence_reference", external_review["evidence_packet_fields"])
        self.assertIn("sanitization_check", external_review["evidence_packet_fields"])
        self.assertTrue(external_review["approval_trace_evidence_required"])
        self.assertTrue(external_review["audit_event_evidence_required"])
        self.assertTrue(external_review["release_validation_evidence_required"])
