...
const FALLBACK_EVIDENCE_REWARD = {
  summary: {
    ...
    reward_cleanup_status: 'blocked_by_evidence',
    reward_cleanup_open_items: 5,
    reward_cleanup_critical_open_items: 3,
    top_cleanup_item: 'Candidate evidence sample',
    claim_permissions: {
      cautious_internal_reward_review: false,
      blocker_value_review: false,
      after_cost_reward_review: false,
  ...
  reward_by_score_bucket: [],
  aggregations: {
    evidence_reward_cleanup_plan: { status: 'blocked_by_evidence', summary: { open_item_count: 5 }, items: [] },
  },
  evidence_reward_cleanup_plan: {
    status: 'blocked_by_evidence',
    summary: {
      item_count: 7,
      open_item_count: 5,
      ...
      execution_cost_context_rate: 0,
      blocker_rewardable_count: 0,
      simulation_rows_excluded: 0,
      proof_first_rule: 'Ambition is allowed. Proof decides priority.',
      claim_permissions: {
        cautious_internal_reward_review: false,
        blocker_value_review: false,
      ...
      blocked_claims: ['proven_alpha', 'reward_quality_claim', 'blocker_value_claim', 'after_cost_reward_claim', 'automatic_ranking_mutation', 'paper_to_live_readiness', 'live_trading_readiness'],
    ...
    items: [
      { key: 'candidate_evidence_sample', title: 'Candidate evidence sample', priority: 'critical', status: 'no_records', missing_fields: ['candidate_lifecycle_id', 'symbol', 'prediction_created_at'], blocked_claims: ['rewardability_review', 'benchmark_input_quality'], safe_next_action: 'Collect candidate lifecycle rows before Evidence Reward can score prediction contracts.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'rewardable_prediction_contracts', title: 'Rewardable prediction contracts', priority: 'critical', status: 'no_records', missing_fields: ['prediction_created_at', 'predicted_direction', 'prediction_horizon_minutes', 'predicted_target_pct', 'invalidation_level', 'confidence', 'actual_forward_return', 'baseline_forward_return'], blocked_claims: ['reward_quality_claim', 'score_bucket_reward_claim'], safe_next_action: 'Emit timestamped predictions with direction, horizon, target, invalidation, confidence, actual return, and baseline return.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'outcome_and_baseline_coverage', title: 'Outcome and baseline coverage', priority: 'critical', status: 'no_records', missing_fields: ['actual_forward_return', 'baseline_forward_return', 'actual_forward_return_observed_at'], blocked_claims: ['baseline_relative_reward', 'professional_benchmark_input'], safe_next_action: 'Attach closed-horizon actual forward returns and same-window baselines before computing reward claims.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'execution_cost_context', title: 'Execution cost context', priority: 'high', status: 'no_records', missing_fields: ['slippage_bps', 'spread_bps', 'route', 'paper_fill_price'], blocked_claims: ['after_cost_reward_claim', 'tradability_claim'], safe_next_action: 'Attach paper spread, slippage, route, and fill-price evidence before treating rewards as after-cost.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'blocker_value_evidence', title: 'Blocker value evidence', priority: 'high', status: 'no_records', missing_fields: ['blockers', 'blocked', 'actual_forward_return', 'baseline_forward_return'], blocked_claims: ['blocker_value_claim', 'false_block_rate_claim'], safe_next_action: 'Collect blocked candidate outcomes and baselines before judging whether blockers helped or blocked winners.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'simulation_separation', title: 'Simulation evidence separation', priority: 'critical', status: 'ready', missing_fields: [], blocked_claims: ['real_time_observed_edge_claim', 'benchmark_edge_claim'], safe_next_action: 'Keep simulation evidence excluded from real-time market-observed rewardability and benchmark inputs.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'manual_ranking_review_boundary', title: 'Manual ranking review boundary', priority: 'critical', status: 'ready', missing_fields: [], blocked_claims: ['automatic_ranking_mutation', 'live_trading_readiness', 'ai_order_authority'], safe_next_action: 'Keep reward recommendations as manual research review only; do not mutate ranking weights or execution policy.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false, clears_kill_switch: false },
    ],
    safe_next_actions: [],
    research_only: true,
    can_submit_orders: false,
...
const FALLBACK_FORECAST_VALIDATION = {
  summary: {
    ...
    forecast_hardening_status: 'blocked_by_evidence',
    forecast_hardening_open_items: 5,
    forecast_hardening_critical_open_items: 3,
    top_hardening_item: 'Forecast contract sample',
    claim_permissions: {
      cautious_internal_forecast_review: false,
    ...
    records: [],
    forecast_validation_hardening_plan: {
      status: 'blocked_by_evidence',
      summary: {
        item_count: 7,
        open_item_count: 5,
        ...
        ready_item_count: 2,
        top_hardening_item: 'Forecast contract sample',
        actual_path_coverage: 0,
        complete_contract_coverage: 0,
        target_metric_coverage: 0,
        missing_data_count: 0,
        proof_first_rule: 'Ambition is allowed. Proof decides priority.',
        claim_permissions: {
          cautious_internal_forecast_review: false,
        ...
        blocked_claims: ['forecast_accuracy_claim', 'forecast_edge_claim', 'repeatability_claim', 'automatic_ranking_mutation', 'paper_to_live_readiness', 'live_trading_readiness'],
      ...
      items: [
        { key: 'forecast_contract_sample', title: 'Forecast contract sample', priority: 'critical', status: 'no_records', missing_fields: ['prediction_id', 'symbol', 'prediction_created_at', 'forecast_series'], blocked_claims: ['forecast_review_claim', 'benchmark_forecast_support'], safe_next_action: 'Keep timestamped forecast contracts visible before treating validation as reviewable.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
        { key: 'complete_forecast_contracts', title: 'Complete forecast contracts', priority: 'critical', status: 'no_records', missing_fields: ['prediction_id', 'symbol', 'prediction_created_at', 'horizon_minutes', 'forecast_series', 'predicted_direction', 'predicted_target_pct', 'invalidation_level', 'confidence', 'source'], blocked_claims: ['forecast_accuracy_claim', 'forecast_reward_claim'], safe_next_action: 'Attach direction, target, invalidation, confidence, horizon, source, and forecast series to each forecast contract.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
        { key: 'actual_path_coverage', title: 'Actual path coverage', priority: 'critical', status: 'no_records', missing_fields: ['actual_series', 'actual_price', 'timestamp_offset'], blocked_claims: ['forecast_accuracy_claim', 'path_quality_claim'], safe_next_action: 'Attach actual post-prediction price paths broadly, not only fixture examples.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
        { key: 'target_invalidation_metrics', title: 'Target and invalidation metrics', priority: 'high', status: 'no_records', missing_fields: ['target_hit', 'invalidation_hit', 'time_to_target', 'max_adverse_excursion'], blocked_claims: ['target_quality_claim', 'risk_adjusted_forecast_claim'], safe_next_action: 'Keep target hit, invalidation hit, time-to-target, and max-adverse metrics attached to validated forecasts.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
        { key: 'calibration_and_regime_context', title: 'Calibration and regime context', priority: 'high', status: 'no_records', missing_fields: ['confidence', 'confidence_calibration_summary', 'regime', 'performance_by_regime'], blocked_claims: ['calibrated_forecast_claim', 'regime_stability_claim'], safe_next_action: 'Report confidence calibration and regime attribution before claiming forecast stability.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
        { key: 'immutable_validation_boundary', title: 'Immutable validation boundary', priority: 'critical', status: 'ready', missing_fields: [], blocked_claims: ['mutable_forecast_record', 'hindsight_edited_forecast_claim'], safe_next_action: 'Keep original forecast contracts immutable and store validation outcomes separately.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
        { key: 'research_only_safety_boundary', title: 'Research-only safety boundary', priority: 'critical', status: 'ready', missing_fields: [], blocked_claims: ['automatic_ranking_mutation', 'live_trading_readiness', 'ai_order_authority'], safe_next_action: 'Keep forecast validation read-only; do not alter execution, broker routes, risk gates, or ranking weights.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_ranking_weights: false },
      ],
      safe_next_actions: [],
      research_only: true,
      can_submit_orders: false,
    ...
    aggregations: { forecast_validation_hardening_plan: { status: 'blocked_by_evidence', summary: { open_item_count: 5 }, items: [] } },
    missing_fields: {},
    warnings: [],
    finish_tracker: FALLBACK_FINISH_TRACKER,
  },
...
const FALLBACK_RESEARCH_PROMOTION = {
  ...
  summary: {
    ...
    execution_traceability_coverage: 0,
    manual_review_record_count: 0,
    research_promotion_cleanup_status: 'blocked_by_evidence',
    research_promotion_cleanup_open_items: 6,
    research_promotion_cleanup_critical_open_items: 5,
    top_cleanup_item: 'Research entity sample',
    claim_permissions: {
      cautious_internal_promotion_review: false,
      paper_proven_research_review: false,
  ...
  research_promotion_cleanup_plan: {
    status: 'blocked_by_evidence',
    summary: {
      item_count: 7,
      open_item_count: 6,
      ...
      blocked_claims: ['paper_proven_research_claim', 'small_fund_governance_claim', 'automatic_strategy_promotion', 'ranking_weight_change', 'risk_limit_change', 'broker_route_change', 'paper_to_live_readiness', 'live_trading_readiness'],
    ...
    items: [
      { key: 'research_entity_sample', title: 'Research entity sample', priority: 'critical', status: 'no_records', missing_fields: ['entity_id', 'entity_type', 'promotion_status', 'safe_explanation'], blocked_claims: ['promotion_readiness_claim', 'governance_workflow_claim'], safe_next_action: 'Keep at least one traceable research entity visible before treating promotion workflow as reviewable.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'status_and_criteria_traceability', title: 'Status and criteria traceability', priority: 'critical', status: 'no_records', missing_fields: ['promotion_status', 'safe_explanation', 'criteria_passed', 'criteria_failed'], blocked_claims: ['promotion_readiness_claim', 'paper_proven_research_claim'], safe_next_action: 'Attach status, safe explanation, passed criteria, and failed criteria to every promotion entity.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'benchmark_and_data_traceability', title: 'Benchmark and data traceability', priority: 'critical', status: 'no_records', missing_fields: ['benchmark_verdict', 'sample_size', 'rewardable_count', 'baseline_relative_edge'], blocked_claims: ['benchmark_backed_promotion_claim', 'paper_proven_research_claim'], safe_next_action: 'Link promotion entities to benchmark verdict, sample, rewardability, baseline-relative evidence, and data-quality fields.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'walk_forward_traceability', title: 'Walk-forward traceability', priority: 'high', status: 'no_records', missing_fields: ['walk_forward_status', 'walk_forward_verdict', 'frozen_experiment_id'], blocked_claims: ['repeatability_claim', 'paper_proven_research_claim'], safe_next_action: 'Link promotion entities to frozen or completed walk-forward experiment evidence before repeatability or paper-proven review.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'execution_traceability', title: 'Execution traceability', priority: 'high', status: 'no_records', missing_fields: ['execution_adjusted_reward', 'slippage_adjusted_reward', 'execution_quality'], blocked_claims: ['tradability_claim', 'paper_to_live_readiness'], safe_next_action: 'Attach execution-adjusted reward or explicit execution-quality evidence before treating promoted research as tradable.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'manual_review_metadata', title: 'Manual review metadata', priority: 'critical', status: 'no_records', missing_fields: ['manual_status.promotion_status', 'manual_status.reason', 'manual_status.updated_at', 'manual_status.evidence_snapshot'], blocked_claims: ['human_approved_promotion_claim', 'small_fund_governance_claim'], safe_next_action: 'Record sanitized manual review metadata with reviewer context when available, reason, previous status, and evidence snapshot.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
      { key: 'metadata_only_safety_governance', title: 'Metadata-only safety governance', priority: 'critical', status: 'ready', missing_fields: [], blocked_claims: ['automatic_strategy_promotion', 'ranking_weight_change', 'risk_limit_change', 'broker_route_change', 'live_trading_readiness'], safe_next_action: 'Keep promotion status disconnected from execution, broker routes, risk gates, risk limits, kill switches, ranking weights, and live trading.', manual_review_only: true, research_only: true, changes_execution: false, changes_order_submission: false, changes_broker_routes: false, changes_risk_gates: false, changes_risk_limits: false, changes_ranking_weights: false, clears_kill_switch: false },
    ],
    safe_next_actions: [],
    research_only: true,
    can_submit_orders: false,
  ...
  aggregations: {
    research_promotion_proof: FALLBACK_RESEARCH_PROMOTION_PROOF,
    research_promotion_cleanup_plan: { status: 'blocked_by_evidence', summary: { open_item_count: 6 }, items: [] },
  },
  warnings: [],
  finish_tracker: FALLBACK_FINISH_TRACKER,
  safety_notes: [
